...
function TransactionsYmir() {
    ...
    useEffect(() => {
        const ymirlogs = logAll.filter(m => m.type === 'YMIR');
    ...
    let displayymirs = filteredData.slice((page - 1) * 10, page * 10);
                            ...
                            <Grid container>
                                ...
                                >
                                    <Stack direction='row' alignItems={'center'} justifyContent="space-between" sx={{ mb: 2 }}>
                                        <Typography component='h5' variant='h5'>YMIR</Typography>
...
export default TransactionsYmir;